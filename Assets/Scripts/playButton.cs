...
public class playButton : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // Buscamos el Fader y el Bot�n por su "Name" del UI Builder
        ...
        {
            Debug.LogError("No encontr� el bot�n 'Play'. Revisa el Name en UI Builder.");
        }
    }
    ...
    IEnumerator FadeAndLoad()
    {
        ...
        // Cargamos la escena cuando la pantalla ya est� negra
